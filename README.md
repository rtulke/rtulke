...
[![My Skills](https://skillicons.dev/icons?i=linux,debian,raspberrypi,kali,python,bash,ansible,puppet,git,vue,c,cpp,javascript&perline=12)](https://skillicons.dev)
