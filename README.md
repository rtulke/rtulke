...
[![My Skills](https://skillicons.dev/icons?i=python,bash,linux,debian,git,ansible,raspberrypi,vue,c,cpp,javascript,ruby,arch,kali&perline=12)](https://skillicons.dev)
