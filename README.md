...
[![My Skills](https://skillicons.dev/icons?i=linux,debian,raspberrypi,kali,solaris,python,bash,ansible,git,vue,c,cpp,javascript&perline=12)](https://skillicons.dev)
